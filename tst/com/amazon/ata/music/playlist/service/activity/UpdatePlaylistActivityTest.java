...
public class UpdatePlaylistActivityTest {
    ...
    public void handleRequest_invalidName_throwsInvalidAttributeValueException() {
        ...
        //added this section below because it was trying to make a call to DynamoDB and finding the id
        // when it doesn't actually exist
        Playlist requestPlaylist = new Playlist();
        requestPlaylist.setName(name);
        requestPlaylist.setId(id);
        requestPlaylist.setCustomerId(customerId);

        when(playlistDao.getPlaylist(request.getId())).thenReturn(requestPlaylist);
